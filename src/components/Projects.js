...
function Projects() {
  const projects = [
    {
      ...
      description:
        "An expansive list of plant species native to Portland, Oregon.",
...

    {
      ...
      description:
        "A template for graphically displaying soil moisture levels, temp, and humidity with an ESP32 microcontroller, InfluxDB, and Grafana.",
...

    {
      ...
      title: "TrailScan",
      description:
        "An app built for hikers. Users can add new trails and review the ones they've hiked.",
...

    {
      ...
      title: "Trakable",
      description:
        "A task management app that allows users to join teams, and contribute to projects by creating and managing tasks.",
...

    {
      ...
      title: "Farm Tracker",
      description:
        "Maintains a record of the production beds on a number of farms, with full CRUD for both Farms and Beds.",
  ...
  const projectCards = projects.map((project) => {
    const { id, title, description, image, website, github } = project;
          ...
          <div className="flip-card-back">
            ...
            <div className="button-container">
              <a href={website} target="_blank" rel="noreferrer">
                {title === "Soil Moisture Sensors" ? null : (
  ...
  return (
    <div id="projects">
      ...
      <section className="projects-container">{projectCards}</section>
    </div>
  );
}
